...
**Link: https://github.com/dmarsh31/media-tracker-android/pull/2/changes/0d49a1ff0b5ed6d132e156c6f639c4ae02293eb3**
...
**Reviewed:** *Patrick McLucas*
**Link to my review: https://github.com/pmclucas/media-tracker-android/pull/1/changes/eaa7689a46df09ee1821b4b437556d9dec2647bb**

### What I Looked At
    The Theme Change, and i also saw he added the image for the login screen

<!-- Walk through the code you reviewed. What was the PR trying to do? Which files or
     functions did you focus on? -->

### What I Noticed
    Just that he also added the image
...
## One Thing I Understood More Deeply
    How the apps ui is created, its really just method calls, looked alot more scary than it was
...
## One Thing I'm Still Confused About
    How these apps run, where do they start, and the nav bar at the bottom is still confusing 
