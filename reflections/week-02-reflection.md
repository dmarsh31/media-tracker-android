...
******Link: https://github.com/dmarsh31/media-tracker-android/pull/4**
...
**Link to my review: https://github.com/pmclucas/media-tracker-android/pull/2**

### What I Looked At
    The 8 Bugs we were assigned

<!-- Walk through the code you reviewed. What was the PR trying to do? Which files or
     functions did you focus on? -->

### What I Noticed
    Same changes as me overall looks good
...
## One Thing I Understood More Deeply
    How the android lifecyle works and how the threads work, viewmodles are rebuilt when reopened, and that is where one of out bugs came from
...
## One Thing I'm Still Confused About
    Just overall syntax and how functions are passed as parameters, just getting used to it as in java its a bit different 
