...
******Link: https://github.com/dmarsh31/media-tracker-android/pull/5**
...
**Link to my review: https://github.com/pmclucas/media-tracker-android/pull/4**
...
### What I Noticed
    he used literals for some parts instead of strings.xml
...
### Comments I Left
    Overall looks good just make sure to use strings.xml
...
## One Thing I Understood More Deeply
    im strating to understand how api calls work in kotlin and how you make a class to "catch" the response
...
## One Thing I'm Still Confused About
    just overall syntax for the backend api part still looks confusing
